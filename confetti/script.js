...
(function () {
  ...
  function init() {
    ...
    heartShape.bezierCurveTo(-2, 0.5, -2, 2, 0, 0);

    const extrudeSettings = {
      steps: 50, // Increase the number of steps for smoother curves
      depth: 0.5,
      bevelEnabled: true,
      bevelThickness: 0.1,
      bevelSize: 0.1,
    ...
    // Scale down the geometry to make the hearts smaller
    heartGeometry.scale(0.02, 0.02, 0.02); // Adjust scale factor as needed

    // Use heartGeometry instead of confettiGeometry
    const confettiGeometry = heartGeometry;
